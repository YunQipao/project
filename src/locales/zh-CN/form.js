export default {
  ...
  'form.status.label': '发放人群',
  'form.status.radio.driver': '司机',
  'form.status.radio.passenger': '乘客',
  'form.value.label': '优惠券金额',
  'form.value.placeholder': '请输入',
  'form.owned.label': '发放人数：',
  'form.owned.placeholder': '请输入',
  'form.coupons.date.label': '起止日期',
  'form.coupons.date.placeholder.start': '开始日期',
  'form.coupons.date.placeholder.end': '截止日期',
  'form.desc.label': '优惠券说明',
  'form.desc.placeholder': '请输入说明',

  'form.notice.title.label': '公告标题',
  'form.notice.title.placeholder': '给公告起个标题',
  'form.content.label': '公告内容',
  'form.content.placeholder': '请输入公告内容',
  'form.notice.desc.label': '附加说明',
  'form.notice.desc.placeholder': '请输入附加说明',
};
