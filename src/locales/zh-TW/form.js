export default {
  ...
  'form.status.label': '發放人群',
  'form.status.radio.driver': '司機',
  'form.status.radio.passenger': '乘客',
  'form.value.label': '優惠券金額',
  'form.value.placeholder': '請輸入',
  'form.owned.label': '發放人數：',
  'form.owned.placeholder': '請輸入',
  'form.coupons.date.label': '起止日期',
  'form.coupons.date.placeholder.start': '開始日期',
  'form.coupons.date.placeholder.end': '截止日期',
  'form.desc.label': '優惠券說明',
  'form.desc.placeholder': '請輸入說明',

  'form.notice.title.label': '公告標題',
  'form.notice.title.placeholder': '給公告起個標題',
  'form.content.label': '公告内容',
  'form.content.placeholder': '請輸入公告內容',
  'form.notice.desc.label': '附加說明',
  'form.notice.desc.placeholder': '請輸入附加說明',
};
