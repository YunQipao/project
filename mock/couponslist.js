...
for (let i = 0; i <50; i += 1) {
  tableListDataSource.push({
    key: i,
    value:'50',
    startTime:'2017-06-02 22:03:56',
    endTime:'2017-06-03 08:04:02',
...
function postCoupons(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
  ...
  return getCoupons(req, res, u);
}


export default {
  'GET /api/coupons': getCoupons,
  'POST /api/coupons': postCoupons,
};
