...
function getUserTest(req, res, u) {
  let url = u;
...
function postUserTest(req, res, u, b) {
  let url = u;
  if (!url || Object.prototype.toString.call(url) !== '[object String]') {
    url = req.url; // eslint-disable-line
  }
  ...
  return getUserTest(req, res, u);
}

export default {
    'GET /api/userstest': getUserTest,
    'POST /api/userstest': postUserTest
  };